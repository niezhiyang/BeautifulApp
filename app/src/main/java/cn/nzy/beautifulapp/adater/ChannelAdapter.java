...
import cn.nzy.beautifulapp.util.channelhelper.OnDragVHListener;
import cn.nzy.beautifulapp.util.channelhelper.OnItemMoveListener;
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    private List<CategoryBean> mMyChannelItems, mOtherChannelItems;

    // 我的频道点击事件
    private OnMyChannelItemClickListener mChannelItemClickListener;
    private OnItemMoveFinsh mOnPositiveListener;

    public ChannelAdapter(Context context, ItemTouchHelper helper, List<CategoryBean> mMyChannelItems, List<CategoryBean> mOtherChannelItems) {
    ...
    private void moveMyToOther(MyViewHolder myHolder) {
        ...
        CategoryBean item = mMyChannelItems.get(startPosition);
        ...
        mOnPositiveListener.onItemFinish(mMyChannelItems,mOtherChannelItems);
    }
    ...
    private void moveOtherToMy(OtherViewHolder otherHolder) {
        ...
        for (CategoryBean a :mMyChannelItems) {
            Log.i(tag+"333-----",a.getName());
    ...
    private int processItemRemoveAdd(OtherViewHolder otherHolder) {
        ...
        CategoryBean item = mOtherChannelItems.get(startPosition);
    ...
    public void onItemMove(int fromPosition, int toPosition) {
        CategoryBean item = mMyChannelItems.get(fromPosition - COUNT_PRE_MY_HEADER);
   ...
   public interface OnItemMoveFinsh {
        void onItemFinish(List<CategoryBean> mMyChannelItems, List<CategoryBean> mOtherChannelItems);
    }

    public void setOnMyChannelItemClickListener(OnMyChannelItemClickListener listener) {
        this.mChannelItemClickListener = listener;
    }
    public void setOnPositiveListener(OnItemMoveFinsh listener) {
