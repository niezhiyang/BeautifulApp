...
public class TopTabLayout extends TabLayout implements ColorUiInterface {
    ...
    public TopTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                //Tab默认颜
                mTabTextColor = a.getColor(R.styleable.TabLayout_tabTextColor, mTabTextColor);
    ...
    public static class ColorTrackTabLayoutOnPageChangeListener extends TabLayoutOnPageChangeListener {
        ...
        public ColorTrackTabLayoutOnPageChangeListener(TabLayout tabLayout) {
            super(tabLayout);
            mTabLayoutRef = new WeakReference<>((TopTabLayout) tabLayout);
        }
        ...
        public void onPageSelected(int position) {
            ...
            TopTabLayout tabLayout = mTabLayoutRef.get();
