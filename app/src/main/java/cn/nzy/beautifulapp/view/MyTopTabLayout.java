 ...
 * @time 15/10/19
 */
public class MyTopTabLayout extends SlidingTabLayout implements Tintable, AppCompatBackgroundHelper.BackgroundExtensible {
    private AppCompatBackgroundHelper mBackgroundHelper;

    public MyTopTabLayout(Context context) {
        this(context, null);
    }

    public MyTopTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.toolbarStyle);
    }

    public MyTopTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
